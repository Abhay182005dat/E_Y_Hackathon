...
export default function App() {
  ...
  return (
    <div className="app-container" style={{ 
      ...
      <div className="border-b" style={{ padding: '8px 24px', fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.2em', fontWeight: 600, display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: darkMode ? '#030712' : '#F8FAFC' }}>
      ...
      <nav className="glass-panel border-b" style={{ position: 'sticky', top: 0, zIndex: 50, width: '100%', transition: 'background-color 0.5s ease' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px', height: '80px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div className="border-all" style={{ padding: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Landmark size={24} style={{ color: theme.accent }} />
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
              <span style={{ fontSize: '20px', fontWeight: 700, letterSpacing: '-0.02em', textTransform: 'uppercase', fontStyle: 'italic' }}>Lumina</span>
              <span style={{ fontSize: '9px', letterSpacing: '0.3em', textTransform: 'uppercase', opacity: 0.6 }}>Institutional</span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            ...
            <button 
              ...
              style={{ padding: '10px 24px', fontSize: '11px', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', transition: 'all 0.3s ease' }}
